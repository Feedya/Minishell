...
typedef struct t_all
{
  ...
  char *line;
  char **path;//le path mais decouper
  char **env_values;//que valeur de variables d environements
  char **env; //variables d environements
} t_all;
...
//METTRE LES VARIABLES D ENVIRONEMENTS DANS DOUBLE QUOTES
...
//METTRE VARIABLES D ENVIRONEMENTS DANS SINGLE QUOTES
